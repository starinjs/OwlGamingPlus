...
function showReleases(releases1)
	if GUIEditor.window[1] and isElement(GUIEditor.window[1]) then
		...
		GUIEditor.label[1] = guiCreateLabel(9, 264, 468, 23, "♦ If you discover a bug/glitch while playing, please report it.\n♦ Your feedback goes a long way towards making our server even better!" , false, GUIEditor.window[1])
